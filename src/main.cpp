...
uint256 hashGenesisBlock("0xa3c32c37d7e658a0a6d7ab54b3dfaa9294f8234332ef7399c10463b7cdd60411");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // PikaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PikaCoin Signed Message:\n";
...
{
    // PikaCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 210001); // PikaCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 21000; // PikaCoin: 3.5 days
static const int64 nTargetSpacing = 210; // PikaCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PikaCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PikaCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // PikaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1d5914dafdc9bbb8542c5176d7dc7c5564ef4d9f7944b3db0ec99de59e5fb316");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Pikabu now has a coin! 24/06/2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("bd5016a5126f809bef39cf4f029db3444c4dba54ac05787552a4ce007a52d6b9c8257c3082f7969bf29870b494bbbc21704dea937523b6273c01e8d8c532bf2059") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1498315069;
        block.nBits    = 504365644;
        block.nNonce   = 4292398978;

        if (fTestNet)
        {
            block.nTime    = 1498315069;
            block.nNonce   = 2655077701;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x023e19b4f0f3c85734e0b99f5547cc8c1f26428f6b47e82db2853c783dcecf55"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // PikaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PikaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PikaCoinMiner : ProcessBlock, block not accepted");
    }
